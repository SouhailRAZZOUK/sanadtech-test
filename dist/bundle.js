...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var DataGridBody_1 = __webpack_require__(12);
var DataGridHead_1 = __webpack_require__(15);
...
var DataGrid = /** @class */ (function (_super) {
    ...
    DataGrid.prototype.render = function () {
        return React.createElement("table", null,
            React.createElement(DataGridHead_1.DataGridHead, { headers: this.props.headersMap }),
            React.createElement(DataGridBody_1.DataGridBody, { data: this.props.data }));
    };
    return DataGrid;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var DataRow_1 = __webpack_require__(13);
...
var DataGridBody = /** @class */ (function (_super) {
    ...
    DataGridBody.prototype.renderDataGridRow = function (item) {
        return (React.createElement(DataRow_1.DataRow, { item: item }));
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var DataRowCell_1 = __webpack_require__(14);
var DataRow = /** @class */ (function (_super) {
    __extends(DataRow, _super);
    function DataRow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataRow.prototype.renderDataRowCell = function (chunk) {
        return (React.createElement(DataRowCell_1.DataRowCell, { chunk: chunk }));
    };
    DataRow.prototype.render = function () {
        ...
        return React.createElement("tr", null, dataRowCells);
    };
    return DataRow;
}(React.Component));
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(1);
var DataRowCell = /** @class */ (function (_super) {
    __extends(DataRowCell, _super);
    function DataRowCell() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataRowCell.prototype.render = function () {
        return React.createElement("td", null, this.props.chunk);
    };
    return DataRowCell;
}(React.Component));
exports.DataRowCell = DataRowCell;
...
// State is never set so we use the '{}' type.
var DataGridHead = /** @class */ (function (_super) {
    __extends(DataGridHead, _super);
    function DataGridHead() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DataGridHead.prototype.renderDataGridHeaderCell = function (property) {
        return (React.createElement("th", null, property));
    };
    DataGridHead.prototype.render = function () {
        var headers = [];
        var data = this.props.headers;
